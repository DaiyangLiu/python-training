...
#Input: 楼栋区域，楼号，房间号 传入字符串
#Return 电量
#example: '东区','沁苑9舍','531'
#check('东区', '沁苑9舍', '531' )

def check(district, building, room ):
    #变量类型检查
    ...
    textmod = {'__VIEWSTATE':
               ...
               'programId': district, 'txtyq': building, 'Txtroom': room, 'ImageButton1.x': '19', 'ImageButton1.y': '16'}
